...
from aceshigh.common import MODE_CHOICES, THEME_CHOICES, FONT_SIZE_CHOICES, KEYBINDIMG_CHOICES
User = get_user_model()
...
class EditorProfile(models.Model):
    ...
    keybinding = models.CharField(max_length=50, choices=KEYBINDIMG_CHOICES, default="ace/keyboard/vscode")
